...
import it.plainvalue.spring.datarest.PersonRepository;
...
public class PersonRepositoryTests {
	...
	public void shouldCreateEntity() throws Exception {
		createFrodoBaggins().andExpect(header().string("Location", containsString("people/")));
	}

	@Test
	public void shouldRetrieveEntity() throws Exception {
		MvcResult mvcResult = createFrodoBaggins().andReturn();
	...
	private ResultActions createFrodoBaggins() throws Exception {
		return mockMvc.perform(post("/people").content("{\"firstName\": \"Frodo\", \"lastName\": \"Baggins\"}"))
